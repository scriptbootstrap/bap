					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-form">
								<form action="bap" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jmlh_penawaran" name="pembayaran_resmi" type="text" class="form-control input-border-bottom filled" required="" value="Rp. 0">
